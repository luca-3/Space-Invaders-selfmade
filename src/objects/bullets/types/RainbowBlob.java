...
public class RainbowBlob extends Bullets {
    ...
    public static void createInstance(int spawnX, int spawnY, boolean isPlayerFriendly, String direction) {
        getInstances().add(
                new RainbowBlob(spawnX,spawnY,60, 50, isPlayerFriendly, direction, "resources/bullets/zwerg.png")
        );
    }



    private RainbowBlob(int x, int y, int width, int height, boolean isPlayerFriendly, String direction, String filepathSkin) {
